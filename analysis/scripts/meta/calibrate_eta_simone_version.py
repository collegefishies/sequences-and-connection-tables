...
if __name__ == '__main__':
	try:
		...
		remove_MeasurementVariance = 0 #boolean
		plot_MeasurementVariance =1 #boolean, 1 will plot measurement resolution vs Neta
		binDef = [7, 150, 2000] #Neta postselecion and binning. Format [bins, min, max] 
		...
		eta = fit_line(bins, nominal_values[:-1], guess=[1], err=errors[:-1])

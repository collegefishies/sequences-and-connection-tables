...
if __name__ == "__main__":
	...
	input_params = {
		"green_mot_frequency":               	{"min":49, "max": 52, "start":50.4, "multiple":False, "num_parameters":1},
		"lattice_loading_frequency":         	{"min":49, "max": 52, "start":50.22, "multiple":False, "num_parameters":1},
		# "x_bias_field_loading":            	{"min":5.09, "max": 5.33, "start":5.1, "multiple":False, "num_parameters":1},
		...
		# "x_bias_field_in_cavity":            				{"min":-2, "max": 2, "start":0.3, "multiple":False, "num_parameters":1},	
		# "y_bias_field_in_cavity":            				{"min":-3, "max": 3, "start":0.3, "multiple":False, "num_parameters":1},
		# "spin_polarization_frequency":     	{"min":48, "max": 51, "start":49, "multiple":False, "num_parameters":1},
		#"red_trap_power_default":           	{"min":0.9, "max":1.1,"multiple":False,"num_parameters":1}
	}
	...
	max_num_runs = get_runs_from_time(h=3)
	max_num_runs_without_better_params = get_runs_from_time(h=3)
	#print the number of runs
	print("max_num_runs:", max_num_runs)
	output = create(
		input_params,
		learner='neural_net',
